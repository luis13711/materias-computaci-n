...
public class Examples_UtilsGUI
{
	...
	public static JTextField putTextfield(Examples_Panel p, String lbl, int len)
	{
		...
		putComponent(p, lbl, txtField);

		return txtField;
	}

	/*******************************************/
	public static void putComponent(Examples_Panel p, String lbl, JComponent comp)
	{
		putComponent(p, lbl, comp, true);
	}
	...
	public static void putComponent(Examples_Panel p, String lbl, JComponent comp
		,boolean isLast)
	{
		p.putComponent(new JLabel(lbl, JLabel.RIGHT));

		if(isLast)
			p.putLastComponent(comp, GridBagConstraints.NONE);
		else
			p.putComponent(comp);
	}
