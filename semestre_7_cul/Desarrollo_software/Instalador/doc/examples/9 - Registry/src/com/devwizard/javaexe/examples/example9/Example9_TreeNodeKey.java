...
public class Example9_TreeNodeKey extends Example9_TreeNode
{
	...
	{
		addNodesReg(Example9_RegistryManagement.nativeReg_EnumKeys(hkeyRoot,pathKey)
	...
	{
		addNodesReg(Example9_RegistryManagement.nativeReg_EnumValues(hkeyRoot,pathKey)
