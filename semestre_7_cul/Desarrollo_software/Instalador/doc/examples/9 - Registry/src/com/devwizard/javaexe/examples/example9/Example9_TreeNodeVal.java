...
public class Example9_TreeNodeVal extends Example9_TreeNode
{
	...
	String getLibelle()
	{
		int type = Example9_RegistryManagement.nativeReg_GetTypeValue(hkeyRoot, pathKey, name);
	...
	String getStringData(int type)
	{
		switch(type)
		{
			...
			case Example9_RegistryManagement.REG_LINK		:
				{
					String s = Example9_RegistryManagement.nativeReg_GetValueSTR(hkeyRoot, pathKey, name, false);
					return(s==null ? null : "\""+s+"\"");
				}

			case Example9_RegistryManagement.REG_MULTI_SZ : return Arrays.toString(Example9_RegistryManagement.nativeReg_GetValueMULTI(hkeyRoot, pathKey, name));

			case Example9_RegistryManagement.REG_BINARY : return getHexData(Example9_RegistryManagement.nativeReg_GetValueBIN(hkeyRoot, pathKey, name));

			case Example9_RegistryManagement.REG_DWORD				:
			case Example9_RegistryManagement.REG_DWORD_BIG_ENDIAN	: return ""+Example9_RegistryManagement.nativeReg_GetValueDWORD(hkeyRoot, pathKey, name);

			case Example9_RegistryManagement.REG_QWORD : return ""+Example9_RegistryManagement.nativeReg_GetValueQWORD(hkeyRoot, pathKey, name);
		}
