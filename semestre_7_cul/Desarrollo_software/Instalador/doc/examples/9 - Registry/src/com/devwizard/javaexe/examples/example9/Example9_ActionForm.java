...
public class Example9_ActionForm
{
	...
	public static boolean newKey(int hkeyRoot, Example9_TreeNodeKey nodeKey)
	{
		...
		return Example9_RegistryManagement.nativeReg_CreateKey(hkeyRoot
	...
	public static boolean newValue(int hkeyRoot, Example9_TreeNodeKey nodeKey)
	{
		...
		return Example9_RegistryManagement.nativeReg_SetValueSTR(hkeyRoot
	...
	public static boolean editValue(int hkeyRoot, Example9_TreeNodeVal nodeVal)
	{
		...
		String[] arr = displayForm("Edit Value", null, null, name+" = "
			,Example9_RegistryManagement.nativeReg_GetValueSTR(hkeyRoot,pathKey,name,false));
	...
	public static boolean delete(int hkeyRoot, Example9_TreeNode node)
	{
		...
		if(isKey)
			return Example9_RegistryManagement.nativeReg_DeleteKey(hkeyRoot, pathKey);

		return Example9_RegistryManagement.nativeReg_DeleteValue(hkeyRoot, pathKey, nameValue);
	}
